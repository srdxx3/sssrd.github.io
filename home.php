        ...
        <div id="app" style="display: none">
            ...
            <div class="content">
                <div class="x-main">
					...
					<div class="link-mod-a"><a>Edit</a></div>
					</div>
...
<div class="mess have-desc" style="margin-bottom: 15px;"><p class="warn-icon"> Login to continue your payment</p></div> <!--- mess have-desc --->
...
<div class="btn-wrap">
<div class="btn">Cancel Payment</div> <!--- btn --->
</div> <!--- btn-wrap --->
</div> <!--- pop-mode --->
</div> <!--- pop-mode-box login --->
